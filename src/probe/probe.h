...
struct probe_sampletab *pmacsys_getcols();
struct probe_rowdiff   *pmacsys_getrowdiff();
char                  **pmacsys_getpub();
void  pmacsys_init();
void  pmacsys_fini();
...
struct probe_sampletab *pmacnames_getcols();
struct probe_rowdiff   *pmacnames_getrowdiff();
char                  **pmacnames_getpub();
void  pmacnames_init();
void  pmacnames_fini();
