 ...
 * Copyright system Garrden Ltd, 1999-2001. All rights reserved.
 */
...
void
on_about_system_garden_activate        (GtkMenuItem     *menuitem,
                                        gpointer         user_data);

void
on_get_license_activate                (GtkMenuItem     *menuitem,
                                        gpointer         user_data);

void
on_get_support_activate                (GtkMenuItem     *menuitem,
                                        gpointer         user_data);

void
on_habitat_usage_activate              (GtkMenuItem     *menuitem,
                                        gpointer         user_data);
...
void
on_stop_local_collect_activate         (GtkMenuItem     *menuitem,
                                        gpointer         user_data);
...
void
on_update_all_activate                 (GtkMenuItem     *menuitem,
                                        gpointer         user_data);
...
void
on_popup_update_activate               (GtkMenuItem     *menuitem,
                                        gpointer         user_data);

void
on_popup_remove_ringstore_activate      (GtkMenuItem     *menuitem,
                                        gpointer         user_data);

void
on_popup_show_raw_activate             (GtkMenuItem     *menuitem,
                                        gpointer         user_data);

void
on_popup_add_ringstore_activate         (GtkMenuItem     *menuitem,
                                        gpointer         user_data);
...
void
on_ctl_zoomin_clicked                  (GtkButton       *button,
                                        gpointer         user_data);

void
on_ctl_zoomout_clicked                 (GtkButton       *button,
                                        gpointer         user_data);

gboolean
on_ctl_zoomin_button_press_event       (GtkWidget       *widget,
                                        GdkEventButton  *event,
                                        gpointer         user_data);

gboolean
on_ctl_zoomout_button_press_event      (GtkWidget       *widget,
                                        GdkEventButton  *event,
                                        gpointer         user_data);
...
void
on_run_data_application_activate           (GtkMenuItem     *menuitem,
                                            gpointer         user_data);
...
void
on_open_host_finish_btn_clicked        (GtkButton       *button,
                                        gpointer         user_data);
...
gboolean
on_stathistory_pix_button_release_event
                                        (GtkWidget       *widget,
                                        GdkEventButton  *event,
                                        gpointer         user_data);
...
void
on_logging_level_activate              (GtkMenuItem     *menuitem,
                                        gpointer         user_data);
...
void
on_logging_level_highest_activate      (GtkMenuItem     *menuitem,
                                        gpointer         user_data);
...
void
on_log_popup_advanced_toggled          (GtkToggleButton *togglebutton,
                                        gpointer         user_data);
