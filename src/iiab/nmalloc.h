...
enum nm_origin {
	...
	NM_ITREE,	/* orgin is ITREE as a friend */ 
	NM_TREE,	/* orgin is TREE as a friend */ 
	NM_PTREE,	/* orgin is PTREE as a friend */
	NM_ANON		/* orgin is anonymous */
};

#define NM_CFNAME "nmalloc"
#define NM_BACKTRACE_SZ 100
