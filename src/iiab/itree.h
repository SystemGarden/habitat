...
ITREE *itree_create(); /* macro prototype */
ITREE *itree_really_create(char *rfile, int rline, const char *rfunc);
void itree_destroy(ITREE *); /* macro prototype */
void itree_really_destroy(ITREE *,char *rfile, int rline, const char *rfunc);
...
ITREE *itree_copystr(ITREE *);

#define itree_create()	itree_really_create(__FILE__,__LINE__,__PRETTY_FUNCTION__)
#define itree_destroy(t) itree_really_destroy(t,__FILE__,__LINE__,__PRETTY_FUNCTION__)
