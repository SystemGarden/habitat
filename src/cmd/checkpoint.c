/*
 * Simple utility to checkpoint a storage system
 * usage: checkpoint <route store>
 *
 * Nigel Stuckey, 1999, 2011
 * Copyright System Garden Ltd 1999-2011. All rights reserved
 */
